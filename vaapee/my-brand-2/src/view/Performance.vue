        ...
        <div class="flex flex-col lg:flex-row items-center justify-between gap-20">
          ...
          <div class="w-full lg:w-2/5 space-y-10" data-aos="fade-left">
            ...
            <div class="pt-6 flex gap-4">
              <button @click="viewDetails(item.id)" class="px-12 py-5 bg-[#39FF14] text-black font-black uppercase text-xs tracking-widest hover:bg-white transition-all shadow-neon">
                View Details
              </button>
              <button class="px-12 py-5 border border-white/20 text-white font-black uppercase text-xs tracking-widest hover:bg-white/10 transition-all">
                Wholesale Inquiry
              </button>
            </div>
          </div>
